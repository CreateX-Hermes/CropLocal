    ...
    <SafeAreaView style={{ backgroundColor: '#FFFFFF' }}>
      <View style={{ backgroundColor: '#FFFFFF', height: '100%' }}>
        ...
        <Text style={styles.text2}>
          If you have any questions, problems or need any assistance please do not hesitate to
          contact us with the email address below.
        </Text>
        <Text style={styles.text3}>
          We will try our best to to assist you with your question or problem in a timely manner.
        ...
        >
          ...
          <Text style={styles.text6}>croplocalhelp@gmail.com</Text>
        </View>
