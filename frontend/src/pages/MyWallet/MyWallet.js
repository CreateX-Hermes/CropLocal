    ...
    <SafeAreaView style={{ backgroundColor: Colors.WHITE }}>
      <View style={{ backgroundColor: Colors.WHITE, height: '100%' }}>
        ...
        <Text style={styles.text1}>
          My
          <Text style={styles.text11}>Wallet</Text>
        </Text>
        <View
          style={{
            backgroundColor: '#F5F5F5',
        ...
        >
          ...
          <Text style={styles.text6}>7039 9323 832 239</Text>
          <Text style={styles.text8}>09/24</Text>
        </View>
        <View
          style={{
            backgroundColor: '#F5F5F5',
        ...
        />
        <Text style={styles.text4}>Payment Methods</Text>
