...
export function Seller({ route }) {
  ...
  const { _id, standName, city, distance, rating, description, ownerName, picture } = route.params;
    ...
    <View>
      ...
      <ScrollView contentContainerStyle={styles.main}>
        ...
        <Text style={styles.subheading}>
          Our
          <Text style={styles.greenSub}>Stock</Text>
        </Text>
        ...
        <Text style={styles.subheading}>
          Your
          <Text style={styles.greenSub}>Seller</Text>
        </Text>
        ...
        <Text style={styles.sellerDescription}>
          Hello all travelers, my name is Greg. I was born in Paris, France, the city of lights. I
          grew up going to school on the west side of the city, and later went to to go to
          University in London. There I studied business administration. I worked for Barclay’s
          french branch in Paris after school.
        </Text>
        <View style={styles.divider} />
        <View style={styles.reviewHeader}>
          <Text style={styles.subheading}>
            Reviews
            <Text style={styles.count}>(253)</Text>
          </Text>
          <View style={styles.ratingContainer}>
            <Image
              resizeMode="contain"
