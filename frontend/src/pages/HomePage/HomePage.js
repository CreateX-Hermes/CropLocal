...
const filterReducer = (state, action) => {
  ...
  if (action.type === 'reduce_max_radius') {
  ...
  if (action.type === 'increase_max_radius') {
          ...
          >
            {filterState.showFav ? (
              <Image
                ...
                style={{ width: '70%', resizeMode: 'contain', tintColor: Colors.RATING }}
              />
            ) : (
              <Image
          ...
          <SafeAreaView backgroundColor="#FFFFFF">
            <View backgroundColor="#FFFFFF" height="100%">
              ...
              <TextInput
                ...
                onPressIn={toggleExtraSearchModal}
              />
              <Divider
                style={{
                  width: '86%',
            ...
            <SafeAreaView backgroundColor="#FFFFFF">
              <View backgroundColor="#FFFFFF" height="100%">
                ...
                <TextInput
                  style={styles.input}
                  placeholder="Atlanta, GA"
                  onEndEditing={toggleExtraSearchModal}
                />
              </View>
            </SafeAreaView>
          </Modal>
